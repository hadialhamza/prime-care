...
const RegisterForm = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto relative group">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rotate-1 group-hover:rotate-0 transition-transform duration-500" />
